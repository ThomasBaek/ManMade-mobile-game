...
- [x] MainPage.xaml in Views folder
- [x] Cash header displays correctly
- [x] Operations list with all 5 operations
- [x] Buttons show prices
- [x] Prestige panel shows when available
